context('<Header/> on desktop', () => {
  ...
  it('should have header nav items', function () {
    cy.findByTestId('DesktopNavbar').within(() => {
      ...
      cy.get('[data-testid="Desktop.HeaderLink.DFCBlog"]').should('be.visible').should('have.attr', 'href', 'https://blog.colefinance.com/')
  ...
  it('should have header nav items', function () {
    cy.findByTestId('Header.OpenMenu').click().then(() => {
      cy.findByTestId('MobileMenu').within(() => {
        ...
        cy.get('[data-testid="Mobile.HeaderLink.DFCBlog"]').should('be.visible').should('have.attr', 'href', 'https://blog.colefinance.com/')
